...
How is the problem fixed?
    ...
    * Remove ConversationStateListener in web.xml of chatbar and chat portlets.
...
Reproduction test
    ...
    * To test this issue, we have to wait until the session time out (about ~30 minutes)
