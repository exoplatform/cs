...
CSCometd.prototype.init = function(forceDisconnect) {
  this._tryToOpenTunnelCnt = 0;
  if ((!forceDisconnect &&
      this._connected) ||
      this._connecting) {
...
CSCometd.prototype.addOnConnectionReadyCallback = function(handle) {
  if (handle) {
    this._connectionReadyCallbacks.push(handle);
  }
};

CSCometd.prototype.removeOnConnectionReadtCallback = function(handle) {
...
CSCometd.prototype.deliver = function(messages){
	messages.each(this._deliver, this);
	return messages;
}

CSCometd.prototype.isConnected = function(){
	return this._connected;
}

CSCometd.prototype._deliver = function(message){
...
CSCometd.prototype._sendMessage = function(/* object */ message){
...
CSCometd.prototype.subscribe = function(	/*String */	channel,
				/*function */	callback){ 
...
CSCometd.prototype.unsubscribe = function(/*string*/ channel){
...
CSCometd.prototype.startBatch = function(){
	this.batch++;
}

CSCometd.prototype.increaseRetryInterval = function() {
...
CSCometd.prototype.resetRetryInterval = function() {
...
CSCometd.prototype.endBatch = function(){
  this._tryToOpenTunnelCnt = 0;
  this._connecting = false;
...
CSCometd.prototype.disconnect = function(){
  this._tryToOpenTunnelCnt = 0;
...
CSCometd.prototype._backoff = function(){
