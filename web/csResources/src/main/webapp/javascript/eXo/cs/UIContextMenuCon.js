...
//			try{				
//				if(UIContextMenuCon.hasChild(document.body, menuElementId)) {
//					var popup = UIContextMenuCon.hasChild(document.body, menuElementId) ;
...
//			}
//			/* ---------------------- */
////      var tmp = UIContextMenuCon.menuElement.cloneNode(true) ;
