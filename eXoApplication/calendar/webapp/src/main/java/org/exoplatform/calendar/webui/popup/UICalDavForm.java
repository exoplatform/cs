...
public class UICalDavForm extends UIFormTabPane implements UIPopupComponent{
  ...
  public UICalDavForm() throws Exception{
    ...
    rssInfo.addUIFormInput(new UIFormStringInput(TITLE, TITLE, "eXoCalendarCalDav").addValidator(MandatoryValidator.class).addValidator(SpecialCharacterValidator.class)) ;
