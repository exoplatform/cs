...
public class EventPageListQuery extends JCRPageList {
  ...
  public EventPageListQuery(String username, String value, long pageSize) throws Exception {
    ...
    value_ = value;
    /*
    value_ = "Select * from exo:calendarEvent where jcr:path like '%/Users/root/ApplicationData/CalendarApplication/calendars/%'"
      + " and jcr:path like '%/exo:applications/CalendarApplication/calendars/%'";
    */    
  ...
  private Node getReminderFolder(Date fromDate)throws Exception { return null;
    //CS-3165
  ...
  private String getPublicServiceHome() throws Exception {
    ...
    if(publicApp != null && publicApp.hasNode(Utils.CALENDAR_APP)) return publicApp.getNode(Utils.CALENDAR_APP).getPath() ;
    return null ;   
  }
  ...
  private String getPrivateServiceHome() throws Exception {
    ...
    if(privateApp != null && privateApp.hasNode(Utils.CALENDAR_APP)) return privateApp.getNode(Utils.CALENDAR_APP).getPath() ;
    return null ;   
  }
