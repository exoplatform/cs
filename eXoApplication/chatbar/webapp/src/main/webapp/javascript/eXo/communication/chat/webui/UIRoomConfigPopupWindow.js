...
*/
UIRoomConfigPopupWindow.prototype = new eXo.communication.chatbar.webui.component.JSUIBean();
...
UIRoomConfigPopupWindow.prototype.onReload = function(eventData) {
  var uiRoomConfigPopupWindow = eXo.communication.chatbar.webui.UIRoomConfigPopupWindow;
...
UIRoomConfigPopupWindow.prototype.switchGroupOptionsAnimate = function() {
  ...
  if (thys.openingNode.offsetHeight < thys.openingNode.maxHeight &&
    ...
    closeLegendNode.innerHTML = eXo.communication.chatbar.webui.UIMainChatWindow.ResourceBundle.chat_message_room_show_config.replace('{0}', closeLegendNode.innerHTML);
...
UIRoomConfigPopupWindow.prototype.fakeConfigCommit = function(keepWindowState) {
  ...
  eXo.communication.chatbar.webui.UIChatWindow.insertCustomMsg(this.UIMainChatWindow.ResourceBundle.chat_message_room_default_config_commit, this.tabId);
};
