...
UIColorPicker.prototype.show = function(obj){
  document.onmousedown = new Function("eXo.contact.UIColorPicker.hide()") ;
...
UIColorPicker.prototype.hide = function() {
  if(eXo.contact.UIColorPicker.tableColor) {
    eXo.contact.UIColorPicker.tableColor.style.display = "none" ;
    eXo.contact.UIColorPicker.tableColor = null ;
    eXo.contact.UIColorPicker.title = null ;
    eXo.contact.UIColorPicker.input = null ;
...
eXo.contact.UIColorPicker = new UIColorPicker() ;