...
public class Utils {
  ...
  public static Contact getContact(Node contactNode, String contactType) throws Exception {
    ...
    if(contactNode.hasProperty("exo:categories"))contact.setAddressBookIds(valuesToStringArray(contactNode.getProperty("exo:categories").getValues()));
    if(contactNode.hasProperty("exo:tags")) contact.setTags(valuesToStringArray(contactNode.getProperty("exo:tags").getValues()));
    if(contactNode.hasProperty("exo:editPermissionUsers")) contact.setEditPermissionUsers(valuesToStringArray(contactNode.getProperty("exo:editPermissionUsers").getValues()));
    if(contactNode.hasProperty("exo:viewPermissionUsers")) contact.setViewPermissionUsers(valuesToStringArray(contactNode.getProperty("exo:viewPermissionUsers").getValues()));
    
    if(contactNode.hasProperty("exo:editPermissionGroups")) contact.setEditPermissionGroups(valuesToStringArray(contactNode.getProperty("exo:editPermissionGroups").getValues()));
    if(contactNode.hasProperty("exo:viewPermissionGroups")) contact.setViewPermissionGroups(valuesToStringArray(contactNode.getProperty("exo:viewPermissionGroups").getValues()));
