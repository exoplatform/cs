...
public class UIAddMessageFilter extends UIForm implements UIPopupComponent{
  ...
  public UIAddMessageFilter() throws Exception {
    ...
    options.add(new SelectItemOption<String>("contains", String.valueOf(Utils.CONDITION_CONTAIN)));
    options.add(new SelectItemOption<String>("doesn't contains", String.valueOf(Utils.CONDITION_NOT_CONTAIN)));
    addUIFormInput(new UIFormSelectBox(FILTER_BODY_CONDITION, FILTER_BODY_CONDITION, options));
    options.add(new SelectItemOption<String>("is", String.valueOf(Utils.CONDITION_IS)));
    options.add(new SelectItemOption<String>("is not", String.valueOf(Utils.CONDITION_NOT_IS)));
    options.add(new SelectItemOption<String>("starts with", String.valueOf(Utils.CONDITION_STARTS_WITH)));
    options.add(new SelectItemOption<String>("ends with", String.valueOf(Utils.CONDITION_ENDS_WITH)));
  ...
  public String getFromCondition() throws Exception {
    return getUIStringInput(FILTER_FROM_CONDITION).getValue();
  }
  
  public void setFromCondition(String s) throws Exception {
    getUIStringInput(FILTER_FROM_CONDITION).setValue(s);
  }
  ...
  public String getToCondition() throws Exception {
    return getUIStringInput(FILTER_TO_CONDITION).getValue();
  }
  
  public void setToCondition(String s) throws Exception {
    getUIStringInput(FILTER_TO_CONDITION).setValue(s);
  }
  ...
  public String getSubjectCondition() throws Exception {
    return getUIStringInput(FILTER_SUBJECT_CONDITION).getValue();
  }
  
  public void setSubjectCondition(String s) throws Exception {
    getUIStringInput(FILTER_SUBJECT_CONDITION).setValue(s);
  }
  ...
  public String getBodyCondition() throws Exception {
    return getUIStringInput(FILTER_BODY_CONDITION).getValue();
  }
