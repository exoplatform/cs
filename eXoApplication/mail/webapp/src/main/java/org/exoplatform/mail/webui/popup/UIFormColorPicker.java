...
import org.exoplatform.mail.Colors.Color;
...
public class UIFormColorPicker extends UIFormInputBase<String>  {
  ...
  public void processRender(WebuiRequestContext context) throws Exception {
    ...
    w.write("<div class='UIFormColorPicker'>") ;
      w.write("<div class=\"UIColorPickerInput\" onclick=\"eXo.mail.UIColorPicker.show(this)\">") ;
      ...
      while(i <= size()/items())  {
        ...
        while(j <= items() && count < size()){
          ...
          String actionLink = "javascript:eXo.mail.UIColorPicker.setColor('"+color.getName()+"')" ;   
