...
UIColorPicker.prototype.show = function(obj){
  document.onmousedown = new Function("eXo.mail.UIColorPicker.hide()") ;
...
UIColorPicker.prototype.hide = function() {
  if(eXo.mail.UIColorPicker.tableColor) {
    eXo.mail.UIColorPicker.tableColor.style.display = "none" ;
    eXo.mail.UIColorPicker.tableColor = null ;
    eXo.mail.UIColorPicker.title = null ;
    eXo.mail.UIColorPicker.input = null ;
...
eXo.mail.UIColorPicker = new UIColorPicker() ;