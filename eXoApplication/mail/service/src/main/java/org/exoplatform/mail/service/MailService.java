 ...
 * <tuan.nguyen@exoplatform.com> Phung Nam <phunghainam@gmail.com> Jun 23, 2007
 */
public interface MailService {

  /**
   * This method should: 1. The service should load the accounts belong to the
   * user and cache in the service. 2. The service should return the list of the
   * account in the cache. If the user hasn't configured an account, an empty
   * list will be cached and return.
   * 
   * @param username
   * @return List<Account>
   * @throws Exception
  ...
  /**
   * This method should: 1. Check if the list of the accounts is cached. If not
   * call the method List<Account> getAccounts(String username) to load all the
   * account belong to the user and cached 2. Find the account in the list of
   * the account and return. 3. return null if no account is found.
   * 
   * @param username
   * @param id
   * @return Account
  ...
  /**
   * Use save for create and update This method should: 1. Check all the
   * madatory field of the account and save the account into the database. The
   * method should throw exception , if any mandatory field is missing. 2. The
   * method should update or invalidate the list of account of the user in the
   * cache
   * 
   * @param username
   * @param account
  ...
  /**
   * This method should: 1. This method check the madatory field and save the
   * updated account into the database 2. This method should update the cache if
  ...
  /**
   * This method remove all the messages in the folder then remove the folder of
   * the account Save the account into the database
   * 
   * @param username
   * @param folderId
   * @param account
  ...
  /**
   * Get MessagePageList by tag id. This method get all message and put it to
   * MessagePageList object this object will use getPage() method to return a
   * list of messages.
   * 
   * @param username
   * @param accountId
  ...
  /**
   * Get MessagePageList by folder id. This method get all message and put it to
   * MessagePageList object this object will use getPage() method to return a
   * list of messages.
   * 
   * @param username
  ...
  /**
   * Check the tag name to see if the tag name is configured in the account If
   * not create a new tag
   * 
   * @param username
   * @param accountId
   * @param tag
   ...
   * Check to see if the tag is already set in the message Add the tag to the
   * message and save the message. Invalidate or update the cache.
   * 
   * @param username
   * @param tag
   * @param message
  ...
  /**
   * Remove the tag from the message Save the message into the database Update
   ...
   * save Remove the tag from the account and save Update or invalidate the
   * cache if needed
   * 
   * @param username
   * @param tag
  ...
  /**
   * Load the message from the database if it existed and return. This method
   * should implement a cache to cache the message by the message id and the
   * username
   * 
   * @param username
   * @param nodeName
  ...
  /**
   * Find all the message according the parameter that is specified in the
   * filter object
   * 
   * @param username
   * @param filter
  ...
  /**
   * Get messages by given filter. This method get all message which are
   * statisfied all conditions of filter
   * 
   * @param username
   * @param accountId
   * @param folderId
  ...
  /**
   * Save message to Account/Messages/Year/Month/Day tree node. If message is
   * new then Day node will create a new node if not it will update the exist
   * message.
   * 
   * @param username
   * @param account
  ...
  /**
   * This method should: 1. Remove the message from the database if it is
   * existed 2. Update or invalidate the cache if the message is cached
   * 
   * @param username
   * @param message
   * @throws Exception
  ...
  /**
   * This method should: 1. Remove all the messages 2. Update or invalidate the
   * cache
   * 
   * @param username
   * @param messageId
   ...
   * and save them in the Inbox folder
   * 
   * @param username
   * @param account
   * @return List<Message>
  ...
  /**
   * Import message to eXo Mail. This method get InputStream and parse it to eXo
   * Message object in special type
   * 
   * @param username
   * @param newSetting
   * @throws Exception
  ...
  /**
   * If the message object didn't load attachment yet, then this method will
   * load it's attachment from JCR and return it's message
   * 
   * @param username
   * @param accountId
   * @param msg
