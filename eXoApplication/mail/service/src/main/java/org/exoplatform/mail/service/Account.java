...
public class Account {
  ...
  public String getSecureAuthsOutgoing() {
    if (secureAuthsOutgoing == Utils.TLS_SSL)
      return "SSL";
  ...
  public boolean isSavePassword() {
    return isSavePassword_;
  }

  public void setIsSavePassword(boolean isSavePassword) {
    isSavePassword_ = isSavePassword;
  }
  ...
  public boolean isEmptyTrashWhenExit() {
    return emptyTrashWhenExit;
  }

  public void setEmptyTrashWhenExit(boolean bool) {
    emptyTrashWhenExit = bool;
  }
  ...
  public boolean isOutgoingAuthentication() {
    return Boolean.valueOf(smtpServerProperties.get(Utils.SMTP_ISAUTHENTICATION));
  }
  ...
  public boolean useIncomingSettingForOutgoingAuthent() {
    return Boolean.valueOf(smtpServerProperties.get(Utils.SMTP_USEINCOMINGSETTING));
  }
  ...
  public String getOutgoingUserName() {
    return smtpServerProperties.get(Utils.SVR_OUTGOING_USERNAME);
  }
  ...
  public String getOutgoingPassword() {
    return smtpServerProperties.get(Utils.SVR_OUTGOING_PASSWORD);
  }
  ...
  public String getProtocol() {
    return serverProperties.get(Utils.SVR_PROTOCOL);
  }
  ...
  public String getIncomingHost() {
    return serverProperties.get(Utils.SVR_INCOMING_HOST);
  }
  ...
  public String getIncomingPort() {
    return serverProperties.get(Utils.SVR_INCOMING_PORT);
  }
  ...
  public String getOutgoingHost() {
    return serverProperties.get(Utils.SVR_OUTGOING_HOST);
  }
  ...
  public String getOutgoingPort() {
    return serverProperties.get(Utils.SVR_OUTGOING_PORT);
  }
  ...
  public boolean isCustomInbox() {
    return Boolean.valueOf(serverProperties.get(Utils.SVR_IS_CUSTOM_INBOX));
  }
  ...
  public String getIncomingFolder() {
    return serverProperties.get(Utils.SVR_INCOMING_FOLDER);
  }
  ...
  public String getIncomingUser() {
    return serverProperties.get(Utils.SVR_INCOMING_USERNAME);
  }
  ...
  public String getIncomingPassword() {
    return serverProperties.get(Utils.SVR_INCOMING_PASSWORD);
  }
  ...
  public boolean isIncomingSsl() {
    return serverProperties.get(Utils.SVR_INCOMING_SSL).equalsIgnoreCase("true");
  }
  ...
  public boolean isOutgoingSsl() {
    return serverProperties.get(Utils.SVR_OUTGOING_SSL).equalsIgnoreCase("true");
  }
  ...
  public void setSmtpServerProperty(String key, String value) {
    if (smtpServerProperties == null)
      smtpServerProperties = new HashMap<String, String>();
