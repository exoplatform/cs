...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/ns:users">
    ...
    <xsl:variable name="allUsersPageLocation">
      <xsl:text>/organization/users.html</xsl:text>
    </xsl:variable>
      ...
      <body>
        <div class="main">
          <div class="inner">
            ...
            <input class="input" type="button" value="Back" style="clear:both; float: left;"
              onclick="history.go(-1);" />
            <input class="input" type="button" value="View All" style="float: left;"
              onclick="top.location='{$allUsersPageLocation}'; return true;" />
