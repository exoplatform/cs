...
@ComponentConfig(
    ...
    template = "app:/templates/forum/webui/UIForumOptionForm.gtmpl",
    events = {
      @EventConfig(listeners = UIForumOptionForm.SaveActionListener.class), 
      @EventConfig(listeners = UIForumOptionForm.CancelActionListener.class)
    }
)
public class UIForumOptionForm extends UIForm {
  
  
  public UIForumOptionForm() {
