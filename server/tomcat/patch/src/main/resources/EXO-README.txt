...
exo Collaboration Suite 1.3.4 features several noteworthy changes:
    ...
    * General
          o Upgraded to portal 2.5.8
          o Compatible with jcr 1.10.7 
          o Compatible with webos 1.5.5
    ...
    * Mail
          o Fixbug
    * Address Book
          o Exclusion group of user
    * Chat
          o Improve package when build product
...
** Improvement
    ...
    * [CS-3275] - Avoid stack-trace in RSS generator at startup
...
** Bug
    ...
    * [CS-3135] - message don't add tag when filter with add tag rule
    * [CS-3138] - Error when edit a draft mail with attachments
    * [CS-3140] - Mail: Little UI error when delete a mail account
    * [CS-3142] - IE7 - contact: Occur wrong message when go to address portlet in special case
